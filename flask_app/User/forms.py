...
from wtforms import StringField, PasswordField, SubmitField , SelectField ,BooleanField ,EmailField
...
class ProfileForm (FlaskForm):
    ...
    phone = StringField('رقم الهاتف',validators=[DataRequired(),Length(min=11,max=11)])
...
class ChangePasswordForm (FlaskForm):
    ...
    confirm_password = PasswordField('أكد الباسورد جديد',validators=[DataRequired(),EqualTo('new_password')])
